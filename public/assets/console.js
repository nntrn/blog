...
;(function () {
  ...
  console.warn = function () {
    ...
    if (args[0].indexOf('You are using the in-browser Babel transformer') !== -1) return

    _warn && _warn.apply(console, args)

    if (!args.length) return

    createLogEntry.apply(null, args).children[0].classList.add('as-console-warning')
  ...
  console.info = function () {
    ...
    createLogEntry.apply(null, args).children[0].classList.add('as-console-info')
